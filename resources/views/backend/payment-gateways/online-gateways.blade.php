          ...
          <div class="card-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                @php $freshpayInfo = json_decode(optional($freshpay)->information, true); @endphp

                <div class="form-group">
                  <label>{{ __('Merchant Id') }}</label>
                  <input type="text" class="form-control" name="freshpay_merchant_id"
                    value="{{ $freshpayInfo['merchant_id'] ?? '' }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="freshpay_merchant_secrete"
                    value="{{ $freshpayInfo['merchant_secrete'] ?? '' }}">
