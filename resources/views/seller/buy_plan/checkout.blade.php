  ...
  <div class="row justify-content-center align-items-center mb-1">
    ...
    <div class="col-md-6 pl-md-0 pr-md-0">
      <div class="card card-pricing card-pricing-focus card-secondary">
        <form id="my-checkout-form" action="{{ route('seller.plan.checkout') }}" method="post"
...
@section('script')
    ...
    $(document).ready(function() {
      $("#payment-gateway").on('change', function() {
        ...
        if (data.indexOf(paymentMethod) != -1) {
          ...
          $.ajax({
            url: '{{ route('seller.payment.instructions') }}',
            headers: {
  ...
  <script src="{{ asset('assets/js/seller-checkout.js') }}"></script>
@endsection
